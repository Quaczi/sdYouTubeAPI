...
<?php
	$name = $_GET['name'];
	$cID = $_GET['cID'];
	$JSON1 = file_get_contents('https://eun1.api.riotgames.com/lol/summoner/v3/summoners/by-name/'.$name.'?api_key=RGAPI-4aea8557-fb2f-4190-aef5-adb2a9887031');
	$json_data1 = json_decode($JSON1, true);
	$sID = $json_data1['id'];
	$JSON = file_get_contents('https://eun1.api.riotgames.com/lol/champion-mastery/v3/champion-masteries/by-summoner/'.$sID.'/by-champion/'.$cID.'?api_key=RGAPI-4aea8557-fb2f-4190-aef5-adb2a9887031');
	$json_data = json_decode($JSON, true);
	$clvl = $json_data['championLevel'];
	$cpkt = $json_data['championPoints'];
	$id = $json_data['championId'];
?>
...
<body>
	<div id="m">ID: <?php echo $sID?></div>
	<div id="m">Nick: <?php echo $name?></div>
	<div id="m">Maestria: <?php echo $clvl?></div>
	<div id="p">Punkty: <?php echo $cpkt?></div>
	<div id="c">Bohater: <?php echo ChIDToName($id)?></div>
</body>